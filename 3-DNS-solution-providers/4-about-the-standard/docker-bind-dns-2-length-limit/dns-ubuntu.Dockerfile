...
COPY fwd.test.it.db /etc/bind/fwd.test.it.db
RUN named-checkzone fwd.test.it /etc/bind/fwd.test.it.db

RUN chmod 760 /etc/bind/fwd.test.it.db
RUN chgrp bind /etc/bind/fwd.test.it.db
